...
urlpatterns = [
    ...
    url(r'^reservations/(?P<reservation_id>\d+)/$',
        ReservationDetailAPIView.as_view(),
        name='reservation_detail_api'),
    url(r'^reservations/create/$',
        ReservationCreateAPIView.as_view({'post': 'create'}),
        name='reservation_create_api'),
    url(r'^reservations/accept/(?P<reservation_id>\d+)/$',
        views.reservation_accept_api,
        name='reservation_accept_api'),
    url(r'^reservations/driver/found/(?P<reservation_id>\d+)/(?P<driver_id>\d+)/$',
        views.reservation_driver_found_api,
        name='reservation_driver_found_api'),
    url(r'^reservations/complete/(?P<reservation_id>\d+)/$',
        views.reservation_complete_api,
        name='reservation_complete_api'),
    url(r'^reservations/cancel/(?P<reservation_id>\d+)/$',
        views.reservation_cancel_api,
        name='reservation_cancel_api'),
]
